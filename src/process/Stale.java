...
public class Stale {
    ...
    public static TimeSeriesCollection series = new TimeSeriesCollection();
    public static final TimeSeries s1 = new TimeSeries("Oryginalny sygnał", Millisecond.class);
    public static final TimeSeries s2 = new TimeSeries("Trend", Millisecond.class);
    ...
    public static int ourScaleStress = 0;
